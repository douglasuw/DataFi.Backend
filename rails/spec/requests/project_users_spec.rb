...
RSpec.describe "/project_users", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ProjectUser.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new ProjectUser" do
        expect {
          post project_users_url, params: { project_user: valid_attributes }
        }.to change(ProjectUser, :count).by(1)
      end

      it "redirects to the created project_user" do
        post project_users_url, params: { project_user: valid_attributes }
        expect(response).to redirect_to(project_user_url(ProjectUser.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new ProjectUser" do
        expect {
          post project_users_url, params: { project_user: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested project_user" do
        project_user = ProjectUser.create! valid_attributes
        patch project_user_url(project_user), params: { project_user: new_attributes }
        project_user.reload
      ...
      it "redirects to the project_user" do
        ...
        patch project_user_url(project_user), params: { project_user: new_attributes }
        project_user.reload
        expect(response).to redirect_to(project_user_url(project_user))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        project_user = ProjectUser.create! valid_attributes
        patch project_user_url(project_user), params: { project_user: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
