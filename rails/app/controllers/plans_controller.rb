class PlansController < ApplicationController
  ...
  private
    ...
    def plan_params
      params.require(:plan).permit(:name, :title, :month_value, :year_value, :recommend, :month_discount_percentual, :year_discount_percentual, :year_discount_value, :month_discount_value)
    end
end
